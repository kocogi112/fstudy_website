...
if (is_user_logged_in()) {
    ...
    $tables = [
        ...
        ['table' => 'save_user_result_ielts_reading', 'base_url' => 'http://localhost/wordpress/ieltsreadingtest/', 'result_column' => 'overallband', 'type' => 'ielts_reading'],
        ['table' => 'save_user_result_ielts_speaking', 'base_url' => 'http://localhost/wordpress/ieltsspeakingtests/', 'result_column' => 'resulttest', 'type' => 'ielts_speaking'],
        ['table' => 'save_user_result_ielts_writing', 'base_url' => 'http://localhost/wordpress/ieltswritingtests/', 'result_column' => 'band_score', 'type' => 'ielts_writing'],
        ['table' => 'save_user_result_ielts_listening', 'base_url' => 'http://localhost/wordpress/ieltslisteningtest/', 'result_column' => 'overallband', 'type' => 'ielts_listening']
    ];
