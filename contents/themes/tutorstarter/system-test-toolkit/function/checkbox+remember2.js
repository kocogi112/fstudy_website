...
function openCheckboxPopup() {
    document.getElementById('checkbox-popup').style.display = 'block';
...
function rememberQuestion(i) {
    if (isFirstClick) {
        Swal.fire({
            title: "Đã thêm vào mục lưu ý",
            text: "Bạn có thể xem review bài làm, các câu hỏi đã được note lại ở có hình ảnh như trên (Bên dưới cùng)",
            imageUrl: "/wordpress/contents/themes/tutorstarter/system-test-toolkit/icon-small-button/checkbox2.png",
            imageHeight: 100,
            imageWidth: 100,
        });

        isFirstClick = false; // Update to indicate the first click has occurred
    }
    ...
    if (checkboxContainer.style.backgroundColor === 'yellow') {
        ...
        bookmarkQuestionElement.src = '/wordpress/contents/themes/tutorstarter/system-test-toolkit/bookmark-1.png';
        ...
        bookmarkQuestionElement.src = '/wordpress/contents/themes/tutorstarter/system-test-toolkit/bookmark-white.png';
    }
}