        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    Group Question Json: <textarea id="edit_group_question" name="group_question" class="form-control"></textarea><br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm">
                    ...
                    Group Question Json: <textarea id="add_group_question" name="group_question" class="form-control"></textarea><br>
...
function openEditModal(number) {
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#edit_key_answer').val(data.key_answer);
