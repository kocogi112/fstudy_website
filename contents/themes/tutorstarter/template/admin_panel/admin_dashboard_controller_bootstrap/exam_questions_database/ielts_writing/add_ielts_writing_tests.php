            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<tr id='row_{$row['number']}'>
                        ...
                        <td>
                                ...
                                <a href='http://localhost/wordpress/ieltswritingtests/{$row['id_test']}' target='_blank'> {$row['id_test']}</a> 
                        ...
                        foreach ($questions as $index => $question) {
                            ...
                            echo "<a href = 'http://localhost/wordpress/contents/themes/tutorstarter/template/admin_panel/admin_dashboard_controller_bootstrap/exam_questions_database/ielts_writing/add_ielts_writing_task_$templatePart.php?id_test_filter=$question' target='_blank'>$question</a>";
