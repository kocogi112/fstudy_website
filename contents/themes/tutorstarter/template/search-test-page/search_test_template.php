...
function renderPlanToday(planData) {
  ...
  planData.forEach(plan => {
    ...
    planCard.innerHTML = `
      <p>Nội dung: ${plan.plan_context}</p>
      <p>Mức độ: <strong>${plan.level}</strong></p>
    `;
