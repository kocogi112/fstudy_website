...
function toggleCheckboxColor(checkboxContainer, questionNumber) {
  ...
  function rememberQuestion(i) {
    ...
    if (checkboxContainer.style.backgroundColor === 'yellow') {
        ...
        bookmarkQuestionElement.src = '/wordpress/contents/themes/tutorstarter/dethithptqg_toolkit/assets/bookmark_empty.png';
    } else {
        checkboxContainer.style.backgroundColor = 'yellow';
        bookmarkQuestionElement.src = '/wordpress/contents/themes/tutorstarter/dethithptqg_toolkit/assets/bookmark_filled.png';
    }
}
