...
<div>
    ...
    <main>
        ...
        if (is_user_logged_in()) {
            ...
            // Render table for IELTS Reading
            render_table_data_with_links('save_user_result_ielts_writing', 'http://localhost/wordpress/ieltsreading/', '_ieltswritingtests_custom_number', $current_username, 'dateform', 'band_score', $wpdb);
