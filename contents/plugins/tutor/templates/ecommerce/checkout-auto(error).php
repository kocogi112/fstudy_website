									...
									//	list( 'is_manual' => $is_manual, 'name' => $name, 'label' => $label, 'icon' => $icon) = $gateway;
										...
										<label class="tutor-checkout-payment-item" data-payment-type="automate">
											...
											<div class="tutor-payment-item-content">
												<img class = "icon-payment" src = "http://localhost/wordpress/contents/uploads/2025/02/MoMo_Logo.png" alt="Momo Auto Payment"/>
												<p> Momo Auto</p>
											</div>
										...
										<label  class="tutor-checkout-payment-item" data-payment-type="automate">
											...
											<div class="tutor-payment-item-content">
												<img class = "icon-payment"   src = "http://localhost/wordpress/contents/uploads/2025/02/VNPay_Logo.jpg" alt="VNPAY Auto Payment"/>
												<p> VNPay Auto</p>
											</div>
